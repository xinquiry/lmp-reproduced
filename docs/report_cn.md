...
| 界面体系 | 晶面取向 | 本工作计算值 ($mJ/m^2$) | 文献参考值 ($mJ/m^2$) | 偏差分析 |
| :--- | :--- | :--- | :--- | :--- |
| **Al / Mg** | (111) // (0001) | **565.08** | ~288.78 | 偏高。表明界面位错网格尚未完全演化成最低能态，需延长退火时间。 |
| **Ti / TiB2** | (0001) // (0001) | **8599.29*** | ~1666.11 | 显著偏高。*注：此数据为静态优化结果。由于体系巨大，未完成完整退火及重构。 |
