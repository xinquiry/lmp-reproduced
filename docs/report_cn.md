...
| 界面体系 | 晶面取向 | 条件 | 本工作PE/atom (eV) | 文献参考值 ($mJ/m^2$) | 状态 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Al / Mg** | (111) // (0001) | 静态 | **-2.49** | ~288.78 | 需进一步分析 |
| **Ti / TiB2** | (0001) // (0001) | 长时退火(100k步) | **-5.95** | ~1666.11 | ✅ 已收敛 |

*注：Ti-TiB2的PE/atom (-5.95 eV) 介于纯Ti (-4.87 eV) 和 TiB2 (-5.6~-7.6 eV) 之间，表明界面区域已充分弛豫并形成了稳定的过渡结构。*
